...
class ALU:
    ...
    def compare(self) -> None:
        # Obtener los datos de la fuente de entrada 'input_a'
        data_a = self.input_a.get_data()

        # Verificar si no hay datos disponibles en 'input_a'
        if data_a is None:
            return  # Retorna sin hacer más cálculos

        # Obtener los datos de la fuente de entrada 'input_b'
        data_b = self.input_b.get_data()

        # Verificar si no hay datos disponibles en 'input_b'
        if data_b is None:
            return  # Retorna sin hacer más cálculos

        # Convertir los datos en números enteros
        number_a = int(data_a)
        number_b = int(data_b)

        # Realizar la comparación de igualdad entre los números
        output = number_a == number_b

        # Establecer los datos de salida como cadena
        self.output.set_data(str(output), None)
